...
(function() {
  var capFirst, global, hasModule, lowerFirst, morph, morphObj, toCamel, toDashed, toHuman, toSnake, toSnakeCaps, toTitle, toUpperCamel,
    _this = this;
  ...
  if (hasModule) {
    return module.exports = morph;
  } else if (typeof define === "function" && define.amd) {
    return define("morph", function() {
      return morph;
    });
  } else {
    return global["morph"] = morph;
  }
}).call(this);
